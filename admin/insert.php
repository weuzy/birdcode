...
<div class="container admin">
    <div class="row">
        <h1 class="text-center"><strong>Ajouter un pigeon</strong></h1>
        <br>
        <form class="form align-self-center" role="form" action="insert.php" method="post" enctype="multipart/form-data" >
